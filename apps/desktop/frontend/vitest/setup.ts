...
beforeEach(() => {
  ...
  vi.spyOn(ProgressService.prototype, 'openIndeterminateProgressIndicator').mockResolvedValue(undefined);
  vi.spyOn(ProgressService.prototype, 'close').mockImplementation(() => {});
